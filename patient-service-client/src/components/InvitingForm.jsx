    ...
    <div>
      <p className="text-center">
        <strong>
          ...
          Вы записаны на госпитализацию для выполнения инъекции антивазопролиферативного препарата на{" "}
      ...
      <p>
        <strong>Заключение специалистов при наличии сопутствующей патологии: </strong> <br />
      ...
      <p className="text-center">
        <strong>
          Получить ответы на все интересующие Вас вопросы Вы можете получить по телефону{" "}
          {lastExamination.phoneForInformation}. Просим Вас приходить строго в назначенные часы, чтобы избежать
          длительного ожидания в очереди. <br />
          <br />
